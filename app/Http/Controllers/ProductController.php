...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('admin.product.index'))->with('success', 'Success! New product has been added.');
    }
    ...
    public function update(Request $request, Product $product)
    {
        ...
        return redirect(route('admin.product.index'))->with('success', 'Success! Product has been updated.');
    }
